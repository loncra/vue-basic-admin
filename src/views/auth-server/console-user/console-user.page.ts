...
export const consoleUserCore: CrudPageCore<ConsoleUserSavePayload, ConsoleUserEntity> = {
  ...
  fields: {
    ...
    gender: {labelKey: 'common.gender', format: 'enum', enumId: SYSTEM_ENUM_TYPE.GENDER_ENUM},
    status: {labelKey: 'common.status', format: 'enum', enumId: SYSTEM_ENUM_TYPE.USER_STATUS_ENUM},
