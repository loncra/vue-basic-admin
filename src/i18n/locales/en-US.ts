...
const locale: LanguagePack = {
  ...
  aiServer: {
    ...
    mcpPackage: {
      routePage: 'MCP marketplace config',
      ...
      initializeTimeout: 'Initialize timeout',
      client: 'Transport',
      clientType: 'Transport type',
      command: 'Command',
      args: 'Arguments',
      env: 'Environment',
      baseUrl: 'Base URL',
      ...
      openConnectionOnStartup: 'Connect on startup',
      resumableStreams: 'Resumable streams',
      clarifyTools: 'Clarify policy',
      fetchTools: 'Fetch tools',
      fetchToolsNeedKeyAndType: 'Fill package key and transport type before fetching tools',
      toolName: 'Tool name',
      description: 'Description',
